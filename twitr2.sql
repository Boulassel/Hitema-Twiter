...
--
-- Client :  localhost
-- Généré le :  Mer 01 Avril 2015 à 11:16
...
INSERT INTO `favoris` (`idUser`, `idMessage`) VALUES
(42, 2),
(42, 22),
(42, 48),
(42, 66),
...
(112, 'test fabrice'),
(113, 'test fabrice'),
(114, 'un twit de boulassel'),
(115, 'un twit de boulassel'),
(116, 'un twit de boulassel');
...
(42, 34, '2015-03-27 15:19:05', 1, 2),
(42, 66, '2015-03-27 16:16:02', 1, 1),
(42, 108, '2015-03-27 15:18:56', 1, 1),
(42, 111, '2015-03-27 11:48:28', 1, 1),
(42, 113, '2015-03-27 11:25:01', 1, 40),
(42, 114, '2015-03-27 14:36:33', 0, 0),
(42, 115, '2015-03-27 14:58:47', 0, 0),
(42, 116, '2015-03-27 14:59:22', 0, 0);
...
(42, 'samir', '$2y$10$myINPfpw/MPjtB7yboyOLOat8MJqVjZiYWYEb2gzKAMDjksy6a4Vq', '7089a2a49c119d81e25846c9c8574d80.jpeg', '2015-03-27 09:56:47', 'boulasselsamir@gmail.com');
...
--
ALTER TABLE `favoris`
 ADD PRIMARY KEY (`idUser`,`idMessage`), ADD KEY `idMessage` (`idMessage`);
...
--
-- Index pour la table `relMessageUsers`
--
ALTER TABLE `relMessageUsers`
...
--
ALTER TABLE `messages`
MODIFY `idMessage` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=117;
--
...
--
ALTER TABLE `favoris`
ADD CONSTRAINT `favoris_ibfk_1` FOREIGN KEY (`idMessage`) REFERENCES `messages` (`idMessage`),
ADD CONSTRAINT `favoris_ibfk_2` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`);
